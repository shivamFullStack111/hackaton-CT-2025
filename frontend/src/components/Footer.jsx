                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                    ...
                    <div className="lg:mx-auto text-left ">
                        ...
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6"><a href="javascript:;" className="text-gray-400 hover:text-gray-100">Home</a></li>
                            <li className="mb-6"><a href="javascript:;" className=" text-gray-400 hover:text-gray-100">About</a></li>
                            <li className="mb-6"><a href="javascript:;" className=" text-gray-400 hover:text-gray-100">Pricing</a></li>
                    ...
                    <div className="lg:mx-auto text-left ">
                        ...
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6"><a href="javascript:;" className="text-gray-400 hover:text-gray-100">Figma UI System</a></li>
                            <li className="mb-6"><a href="javascript:;" className=" text-gray-400 hover:text-gray-100">Icons Assets</a></li>
                            <li className="mb-6"><a href="javascript:;" className=" text-gray-400 hover:text-gray-100">Responsive Blocks</a></li>
                    ...
                    <div className="lg:mx-auto text-left">
                        ...
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6"><a href="javascript:;" className="text-gray-400 hover:text-gray-100">FAQs</a></li>
                            <li className="mb-6"><a href="javascript:;" className=" text-gray-400 hover:text-gray-100">Quick Start</a></li>
                            <li className="mb-6"><a href="javascript:;" className=" text-gray-400 hover:text-gray-100">Documentation</a></li>
                    ...
                    <div className="lg:mx-auto text-left">
                        ...
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6"><a href="javascript:;" className="text-gray-400 hover:text-gray-100">News</a></li>
                            <li className="mb-6"><a href="javascript:;" className=" text-gray-400 hover:text-gray-100">Tips & Tricks</a></li>
                            <li className="mb-6"><a href="javascript:;" className=" text-gray-400 hover:text-gray-100">New Updates</a></li>
                            <li><a href="javascript:;" className=" text-gray-400 hover:text-gray-100">Events</a></li>
                        </ul>
                    </div>
                </div>
