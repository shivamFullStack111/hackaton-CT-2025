...
const LandingPage = () => {
    ...
    const handleNavigate = () => {
        localStorage.setItem("IsWatcheWelcomePage", true)
        navigate('/home')
    }

    useEffect(() => {
        const IsWatcheWelcomePage = localStorage.getItem("IsWatcheWelcomePage")
        if (IsWatcheWelcomePage) {
                ...
                < ResponsiveContainer >
                    <div className='flex w-full   justify-between items-center  mt-10 '>
                        <motion.div initial={{ y: 100, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 3 }} >
                            ...
                            <button onClick={handleNavigate} className='p-2 px-3 mt-8 rounded-lg animate-bounce hover:bg-dark-teal bg-teal text-white text-sm font-semibold  '>Start Your Journey</button>
                        </motion.div>
