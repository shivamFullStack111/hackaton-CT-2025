                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Paste or write the topics you want the quiz to cover. The
                      AI will understand your instructions and generate
                      questions based on the selected difficulty level.
                    </p>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-900 p-4 rounded-lg border border-gray-700">
                    <div className="text-3xl font-bold text-teal">
                      ...
                      {quizData?.timeLimit>0 ?((quizData?.timeLimit % 60).toString().padStart(2, "0")) : 0}{" "}
                      min
                    </div>
                    <div className="text-sm text-gray-400">
                      Estimated Duration
